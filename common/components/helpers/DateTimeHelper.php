...
class DateTimeHelper
{
    ...
    public static function convert($date, $sourceFormat = 'd/m/Y', $targetFormat = 'Y-m-d', $type = 'date')
    {
        ...
        $date = DateTime::createFromFormat($sourceFormat, $sourceDate, new DateTimeZone(Yii::$app->timeZone));

        if ($date instanceof DateTime) {
            $date = $date->format($targetFormat);
        } else {
            $date = DateTime::createFromFormat($targetFormat, $sourceDate, new DateTimeZone(Yii::$app->timeZone));
